            ...
            for zombie in zombie_list:
                ...
                if(view_info[zombie]):
                    for singleZombie in view_info[zombie]:
                        if(len(singleZombie)>2 and singleZombie[2] == "center" and singleZombie[1] > maxZombie):
                            maxZombie = singleZombie[1]
                            turn_right(fr, fl, br, bl)
                        elif (len(singleZombie)>2 and singleZombie[2] == "right" and singleZombie[1] > maxZombie):
                            maxZombie = singleZombie[1]
